export default function Home() {
  return (
    // <div className="flex flex-col gap-[1.11em] bg-[#f86102] p-6 text-[hsl(220,100%,25%)]">
    <div className="flex flex-col gap-[1.11em] bg-[blue] p-6 text-white">
      <header>
        <h2>Article #001</h2>
        <h1 className="title">
      ...
      <article className="content">
        ...
        <p className="fancy">
          I’m still a hospitality designer and there are few things that bring
          me as much joy as my career, but pivoting to the label of artist truly
          liberated me.
        </p>
        <p>
