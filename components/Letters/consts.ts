...
export const COLORS = [
  ...
  // Makes header very hard to see on red theme.
  { hex: "#121013", var: "var(--color-theme-m)", themes: [ThemeNames.BLUE, ThemeNames.YELLOW, ThemeNames.RED] },
  // Blocks header on red theme.
  { hex: "#0b1740", var: "var(--color-theme-k)", themes: [ThemeNames.YELLOW] },
  // Blocks header on blue theme.
  { hex: "#e51545", var: "var(--color-theme-p)", themes: [ThemeNames.YELLOW, ThemeNames.RED] },
];
